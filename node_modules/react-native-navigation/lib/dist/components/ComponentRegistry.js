...
class ComponentRegistry {
    ...
    registerComponent(componentName, getComponentClassFunc, ReduxProvider, reduxStore) {
        ...
        const NavigationComponent = ComponentWrapper_1.ComponentWrapper.wrap(componentName, OriginalComponentClass, this.store, this.componentEventsObserver, ReduxProvider, reduxStore);
